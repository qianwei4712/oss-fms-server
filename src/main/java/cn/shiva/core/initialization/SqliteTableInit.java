...
public class SqliteTableInit {
    ...
    public void init() {
        ...
        if (StringUtils.isBlank(tableName)) {
            createTable = "CREATE TABLE \"file_recovery\"( \"id\" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, \"name\" TEXT, \"sketch\" TEXT, \"size\" integer, \"type\" TEXT, \"last_modify_time\" text, \"oss_path\" TEXT, \"file_path\" TEXT);";
            jdbcTemplate.update(createTable);
        }
        //配置表
